...
summary_path = "results/withoutaci/withoutaci_summary_results.csv"
...
for model in models:
    for loss_function in losses:
        cur_filename = f"results/withoutaci/{model}_{loss_function}_results.csv"
...
print(f"WITHOUT ACI summary table saved to {summary_path}")
